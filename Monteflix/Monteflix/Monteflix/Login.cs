        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (count == 1)
                {
                    ...
                    {
                        con.Open();
                        command = new SqlCommand("select User_ID from Users where User_Name='" + Username + "'and User_Email='" + Email + "' and User_Password='" + Password + "'", con);
